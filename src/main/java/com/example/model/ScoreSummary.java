...
public class ScoreSummary {
	...
	public ScoreSummary(ScoreModel s) {
		...
		scoreInput.put("Declared bankrupcy  in last 5 years", s.getBankruptcy());
		...
		scoreInput.put("Annual income", "£" + Integer.toString(s.getIncome()));
		...
		scoreValues.put("Proportion of loan to annual income", ScoreCalculation.loanProportion(loan, income));
